...
class ChatScreen extends StatefulWidget { // Changed to StatefulWidget
...
class _ChatScreenState extends State<ChatScreen> {
  final TextEditingController _messageController = TextEditingController(); // Controller for text input
  ...
  Widget build(BuildContext context) {
    ...
    final provider = Provider.of<ConversationProvider>(context); // default listen: true
      ...
      body: Column(
        children: [
          Expanded(
            ...
            child: provider.currentChatId == null || provider.currentChatId!.isEmpty
                ? const Center(child: CircularProgressIndicator()) // Show loading until chat ID is set
                : StreamBuilder<QuerySnapshot>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      if (snapshot.hasError) {
                        print('Chat stream error: ${snapshot.error}'); // Log errors
                      ...
                      return ListView.builder(
                        ...
                        itemBuilder: (ctx, index) {
                          ...
                          return Align( // Align messages to left/right
